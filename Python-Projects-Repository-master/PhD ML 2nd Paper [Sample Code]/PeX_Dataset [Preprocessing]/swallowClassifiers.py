...
dt_classifier1 = DecisionTreeClassifier(random_state=0, criterion="entropy", splitter="random", max_depth=2)
dt_classifier2 = DecisionTreeClassifier(random_state=0, criterion="entropy", splitter="random", max_depth=2, max_leaf_nodes=100, min_samples_leaf=2, ccp_alpha=0.0001)
...
rf_classifier1 = RandomForestClassifier(max_depth=4, min_samples_split=20, min_samples_leaf=150, n_estimators=1000,
...
rf_classifier2 = RandomForestClassifier(max_depth=4, min_samples_split=20, min_samples_leaf=150, n_estimators=350,
...
lgbmclassifier1 = lgb.LGBMClassifier(max_depth=12, num_leaves=4000, min_data_in_leaf=6500, learning_rate=0.99,
                                  verbose=5, lambda_l1=15, lambda_l2=15, min_gain_to_split=0.12, bagging_fraction=0.8,
                                  bagging_freq=1, feature_fraction=0.5)

lgbmclassifier2 = lgb.LGBMClassifier(max_depth=6, num_leaves=1700, min_data_in_leaf=7500, learning_rate=0.15,
                                    verbose=5, lambda_l1=0.03, lambda_l2=0, min_gain_to_split=12.71, bagging_fraction=0.3,
                                    bagging_freq=1, feature_fraction=0.7)

lgbmclassifier3 = lgb.LGBMClassifier(learning_rate=0.1, max_bin=20, max_depth=20, min_child_samples=30, min_data_in_bin=10,
                         min_split_gain=0.1, n_estimators=100, num_leaves=20, reg_alpha=0.01, reg_lambda=0.01, n_jobs=1,
                         verbose=5)
...
extraTreesClf2 = ExtraTreesClassifier(n_estimators=100, max_leaf_nodes=100, min_samples_leaf=2, min_samples_split=10, random_state=0)

extraTreesClf3 = ExtraTreesClassifier(max_depth=300, n_estimators=100, max_leaf_nodes=100, min_samples_leaf=2, min_samples_split=10, ccp_alpha=0.0001,  random_state=0)
...
sgdc1 = SGDClassifier(max_iter=5000, tol=0.00000001, loss='modified_huber', early_stopping=True, learning_rate='optimal', class_weight='balanced', verbose=5)
sgdc2 = SGDClassifier(learning_rate='optimal', loss='log', max_iter=3000000, validation_fraction=0.5,
                    n_jobs=-1, verbose=5, early_stopping=True)
...
logiRegClf1 = LogisticRegression(solver='sag', max_iter=1000, tol=0.01, multi_class='multinomial', verbose=5)
...
knnJaccardClf1 = KNeighborsClassifier(algorithm='auto', leaf_size=30, metric='minkowski',
