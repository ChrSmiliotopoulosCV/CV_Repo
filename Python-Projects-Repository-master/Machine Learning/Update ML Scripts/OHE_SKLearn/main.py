...
df = pd.read_csv(r'/Volumes/Backup_Volume/GitHub Repository/GitHub Python Projects/Python-Projects-Repository/Machine Learning/Update ML Scripts/OHE_SKLearn/melb_data.csv')
