...
data = pd.read_csv((
    r"/Users/christossmiliotopoulos/Desktop/myRepos/myPersonal_Git_Record/Python Data Encoding Scripts/customFeatures/timeDiffDeauthReauth()/timeDiffDeauthReauth().csv"))
data.head()
