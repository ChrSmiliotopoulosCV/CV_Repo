# packetExchangeBtw2HostsInt for .csv frames counting python script
# Importing Libraries
import pandas as pd
import sklearn
import numpy as np
...
data = pd.read_csv((
    r"D:\Personal Projects\Διδακτορικό\AWID3 Machine Learning Project\Python Data Encoding Scripts\customFeatures\packetExchangeBtw2Hosts\packetExchangeBtw2Hosts.csv"))
data.head()
...
# bytes sent for each receiverAddress group and the number of the packets that have been exchanged between the two
# hosts inside the same network.
