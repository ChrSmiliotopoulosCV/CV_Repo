# avgPayloadPacketLength() for .csv frames counting python script
# Importing Libraries
import pandas as pd
import sklearn
import numpy as np
...
data = pd.read_csv((
    r"D:\Personal Projects\Διδακτορικό\AWID3 Machine Learning Project\Python Data Encoding Scripts\customFeatures\avgPayloadPacketLength()\avgPayloadPacketLength().csv"))
data.head()
