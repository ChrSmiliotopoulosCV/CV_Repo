...
for train, test in skf.split(inputs, targets):
    ...
    # print(y_train_skf)
    # print(y_test_skf)
    adaBoost_Classifier.fit(X_train_skf, y_train_skf)  # Naive Bayes model nb.fit algorithm training.
    y_pred_skf = adaBoost_Classifier.predict(X_test_skf)  # y_pred_skf variable is used to store in memory the prediction of
    ...
    plot_confusion_matrix(adaBoost_Classifier, X_test_skf, y_test_skf)
    plt.show()
