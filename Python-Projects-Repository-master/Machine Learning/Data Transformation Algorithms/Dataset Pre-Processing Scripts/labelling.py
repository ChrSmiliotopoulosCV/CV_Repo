...
data = pd.read_csv((r"C:\Users\chrsm\Desktop\Extensions to PeX Lateral Movement Dataset\Stefania\stefaniaLogsAllBaseForLabeled.csv"), encoding="ISO-8859-1", low_memory=False)
data.head()
...
df.to_csv('stefaniaLogsAllLabeled1.csv')
