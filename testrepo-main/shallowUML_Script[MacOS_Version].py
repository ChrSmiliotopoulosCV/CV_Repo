...
path = r"/Users/christossmiliotopoulos/Documents/GitHub/testrepo/LMD-2023 Dataset/Prints/One SVM/OneSVMLogSmallSet06.txt"
...
# X_train, X_test, y_train, y_test = train_test_split(X, y, train_size=0.05, test_size=0.025)
...
# model = OneClassSVM(gamma='auto', verbose=True)
model = linear_model.SGDOneClassSVM(tol=0.0004, learning_rate='optimal', eta0=10, random_state=42, verbose=99)
