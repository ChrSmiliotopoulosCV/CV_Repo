...
path = (r"C:\Users\chrsm\Desktop\Paper_no4 - Unsupervised ML LMD-2023 Paper\GitHub_Repository\testrepo\preprocessingLogs.txt")
...
concatDF = pd.read_csv((r"C:\Users\chrsm\Desktop\Paper_no4 - Unsupervised ML LMD-2023 Paper\GitHub_Repository\testrepo\newAttempt(DeletedExtraRows)Labeled.csv"), encoding="utf-8", low_memory=False)
...
concatDF.to_csv(r'C:\Users\chrsm\Desktop\Paper_no4 - Unsupervised ML LMD-2023 Paper\GitHub_Repository\testrepo\pexLabeledDataset1(NoJunkData).csv')
...
concatDFNoJunkData = pd.read_csv((r"C:\Users\chrsm\Desktop\Paper_no4 - Unsupervised ML LMD-2023 Paper\GitHub_Repository\testrepo\pexLabeledDataset1(NoJunkData).csv"), encoding="utf-8", low_memory=False)
...
df_selection = pd.DataFrame(concatDF, columns=['EventID', 'SystemTime', 'EventRecordID', 'Execution_ProcessID', 'Computer', 'ProcessId', 'Initiated', 'SourceIsIpv6', 'DestinationPortName', 'Label'])
...
df_selection.to_csv(r'C:\Users\chrsm\Desktop\Paper_no4 - Unsupervised ML LMD-2023 Paper\GitHub_Repository\testrepo\selectedRawLabeledFeaturesNew.csv')

selectedRawLabeledFeaturesNewDF = pd.read_csv((r"C:\Users\chrsm\Desktop\Paper_no4 - Unsupervised ML LMD-2023 Paper\GitHub_Repository\testrepo\selectedRawLabeledFeaturesNew.csv"), encoding="utf-8", low_memory=False)
...
selectedRawLabeledFeaturesNewDF.to_csv(r"C:\Users\chrsm\Desktop\Paper_no4 - Unsupervised ML LMD-2023 Paper\GitHub_Repository\testrepo\selectedRawLabeledFeaturesNoNullNew.csv")
...
selectedRawLabeledFeaturesNewDF.to_csv(r"C:\Users\chrsm\Desktop\Paper_no4 - Unsupervised ML LMD-2023 Paper\GitHub_Repository\testrepo\selectedRawLabeledFeaturesNoNullNoDashedFileNew.csv")
...
df_timeDate.to_csv(r"C:\Users\chrsm\Desktop\Paper_no4 - Unsupervised ML LMD-2023 Paper\GitHub_Repository\testrepo\selectionTimeDateSOSNew.csv")
...
df_timeDate['SystemTime'] = pd.to_datetime(df_timeDate['SystemTime'], format = '%Y-%m-%d %H:%M:%S.%f', errors = 'coerce')
...
df_timeDate.to_csv(r"C:\Users\chrsm\Desktop\Paper_no4 - Unsupervised ML LMD-2023 Paper\GitHub_Repository\testrepo\selectionTimeDateToTimeDateNew.csv")
...
# The df_timeDate['SystemTime'] dataframe is then extracted to a more easily manipulated .csv format. 
df_timeDate_Limited.to_csv(r"C:\Users\chrsm\Desktop\Paper_no4 - Unsupervised ML LMD-2023 Paper\GitHub_Repository\testrepo\selectionTimeDateToTimeDateLimitedNew.csv")
...
df1_FeatureSelection = pd.read_csv((r"C:\Users\chrsm\Desktop\Paper_no4 - Unsupervised ML LMD-2023 Paper\GitHub_Repository\testrepo\selectedRawLabeledFeaturesNoNullNoDashedFileNew.csv"), encoding="ISO-8859-1", low_memory=False)
...
print(len(df3))
df3.to_csv(r"C:\Users\chrsm\Desktop\Paper_no4 - Unsupervised ML LMD-2023 Paper\GitHub_Repository\testrepo\df3NoNullNoDushedFeaturesLabeledNew.csv")

df2_TimeFeatures = pd.read_csv((r"C:\Users\chrsm\Desktop\Paper_no4 - Unsupervised ML LMD-2023 Paper\GitHub_Repository\testrepo\selectionTimeDateToTimeDateLimitedNew.csv"), encoding="ISO-8859-1", low_memory=False)
...
print(len(df5))
df5.to_csv(r"C:\Users\chrsm\Desktop\Paper_no4 - Unsupervised ML LMD-2023 Paper\GitHub_Repository\testrepo\df5NoNullNoDushedTimeFeaturesLabeledNew.csv")
...
df1Features = pd.read_csv((r"C:\Users\chrsm\Desktop\Paper_no4 - Unsupervised ML LMD-2023 Paper\GitHub_Repository\testrepo\df3NoNullNoDushedFeaturesLabeledNew.csv"), encoding="ISO-8859-1", low_memory=False)
df2TimeFeatures = pd.read_csv((r"C:\Users\chrsm\Desktop\Paper_no4 - Unsupervised ML LMD-2023 Paper\GitHub_Repository\testrepo\df5NoNullNoDushedTimeFeaturesLabeledNew.csv"), encoding="ISO-8859-1", low_memory=False)
...
result.to_csv(r"C:\Users\chrsm\Desktop\Paper_no4 - Unsupervised ML LMD-2023 Paper\GitHub_Repository\testrepo\mergedDFConcatDerivedNew.csv")
...
mergedDF3 = pd.read_csv((r"C:\Users\chrsm\Desktop\Paper_no4 - Unsupervised ML LMD-2023 Paper\GitHub_Repository\testrepo\mergedDFConcatDerivedNew.csv"), encoding="ISO-8859-1", low_memory=False)
...
ohe.to_csv(r'C:\Users\chrsm\Desktop\Paper_no4 - Unsupervised ML LMD-2023 Paper\GitHub_Repository\testrepo\ohePreProcessedDatasetNew.csv')
...
minMaxScaled.to_csv(r'C:\Users\chrsm\Desktop\Paper_no4 - Unsupervised ML LMD-2023 Paper\GitHub_Repository\testrepo\minMaxScaledPreProcessedDatasetNew.csv')
minMaxScaled.to_csv(r'C:\Users\chrsm\Desktop\Paper_no4 - Unsupervised ML LMD-2023 Paper\GitHub_Repository\testrepo\oheMinMaxPreProcessedDatasetNew.csv')